...
build_time_vars = {'ABIFLAGS': '',
 ...
 'AR': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang '
              '-shared '
              '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
              '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
              '-Wl,--fix-cortex-a8',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang',
 'CCSHARED': '',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/include',
 'CONFIGURE_LDFLAGS': '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
                      '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
                      '-Wl,--fix-cortex-a8',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--host=armv7a-linux-androideabi' '--build=x86_64-linux-gnu' "
                ...
                "'CC=/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang' "
                "'CFLAGS=-fPIC' "
                "'LDFLAGS=-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib "
                "-pie' "
                "'CPPFLAGS=-I/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/include' "
                "'CPP=/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang "
                "-E' "
                "'PKG_CONFIG_LIBDIR=/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/data/python3-android-master/src/Python-3.9.7/coverage.info',
 'COVERAGE_REPORT': '/data/python3-android-master/src/Python-3.9.7/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/include',
 'CXX': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang++',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'armv7a-unknown-linux-androideabi',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang++ '
                '-shared',
 'LDFLAGS': '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
            '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
            '-Wl,--fix-cortex-a8',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang '
             '-shared '
             '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
             '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
             '-Wl,--fix-cortex-a8',
 ...
 'LINKCC': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang',
 ...
 'MAINCC': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi21-clang',
 'MAJOR_IN_MKDEV': 0,
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/data/python3-android-master/src/Python-3.9.7 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/data/python3-android-master/src/Python-3.9.7/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -Wno-unused-result '
                   ...
                   '-Wall -fPIC -std=c99 -Wextra -Wno-unused-result '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Wstrict-prototypes -Werror=implicit-function-declaration '
                   '-fvisibility=hidden  -I./Include/internal -I. -I./Include '
                   '-I/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
                    '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
                    '-Wl,--fix-cortex-a8',
 'PY_CPPFLAGS': '-I. -I./Include '
                '-I/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/data/python3-android-master/src/Python-3.9.7/Android/sysroot/usr/lib '
               '-pie -Wl,-soname,libpython3.9.so -march=armv7-a '
               '-Wl,--fix-cortex-a8',
 'PY_LDFLAGS_NODIST': '',
 ...
 'PY_STDMODULE_CFLAGS': '-mfloat-abi=softfp -mfpu=vfpv3-d16 -Wno-unused-result '
                        ...
                        '-O3 -Wall -fPIC -std=c99 -Wextra -Wno-unused-result '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
 ...
 'READELF': '/data/local/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-readelf',
 ...
 'abs_builddir': '/data/python3-android-master/src/Python-3.9.7',
 'abs_srcdir': '/data/python3-android-master/src/Python-3.9.7',
